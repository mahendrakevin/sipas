                                                ...
                                                <td>
                                                    <div class="tab-pane tab-example-design fade show active" id="pills-button-icon-fixed-design" role="tabpanel" aria-labelledby="pills-button-icon-fixed-design-tab">
                                                        <button type="button" class="btn btn-warning btn-icon">
                                                            <a href="{{ route('admin.setting.level.edit', ['id' => $user_level->id]) }}"><i data-feather="edit" class="nav-icon icon-xs me-2"></i></a>
                                                        </button>
                                                        <button type="button" class="btn btn-danger btn-icon">
                                                            <a href="{{ route('admin.setting.level.destroy', ['id' => $user_level->id]) }}"><i data-feather="delete" class="nav-icon icon-xs me-2"></i></a>
                                                        </button>
                                                    </div>
                                                </td>
                                            </tr>
